    ...
    <div className=" pt-6 pb-6">
      ...
      <div className="flex items-center space-x-3">
        ...
        <button
          ...
          className="flex items-center justify-center w-10 h-10 bg-black text-white hover:bg-gray-800 transition-colors"
        ...
        <button
          ...
          className="flex items-center justify-center w-10 h-10 bg-orange-600 text-white hover:bg-orange-700 transition-colors"
